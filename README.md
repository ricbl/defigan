...
Dataset | NCC | Input image ($x$) |  Desired change ($\Delta x$)  |  Deformation Field ($\phi$) | Produced change (\(\widehat{\Delta x}\)) | \(\widehat{\Delta x}\) over $x$| Modified image ($\hat{x}_0$)
--- | --- | --- | --- | --- | --- | --- | ---
...
Dataset | NCC | Input image ($x$) |  Desired change ($\Delta x$) | Produced change (\(\widehat{\Delta x}\)) | \(\widehat{\Delta x}\) over $x$| Modified image ($\hat{x}_0$)
--- | --- | --- | --- | --- |  --- | ---
Toy | 0.532 | ![](https://github.com/ricbl/defigan/raw/master/readme_images/add/toy/x1.png)  |  ![](https://github.com/ricbl/defigan/raw/master/readme_images/add/toy/difference_gt.png)   | ![](https://github.com/ricbl/defigan/raw/master/readme_images/toy/add/difference.png) | ![](https://github.com/ricbl/defigan/raw/master/readme_images/toy/add/difference_overlaid.png) | ![](https://github.com/ricbl/defigan/raw/master/readme_images/add/toy/xhat0.png)
